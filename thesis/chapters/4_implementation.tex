...
%  A következő szekcióban a játékban megvalósított rendszereket mutatom be, amelyek a játékmenetet és a felhasználói élményt szolgálják. A rendszerek részletes leírása mellett bemutatom a kód részleteket is, amelyek segítségével könnyen megérthető, hogyan történik az egyes rendszerek működése.
